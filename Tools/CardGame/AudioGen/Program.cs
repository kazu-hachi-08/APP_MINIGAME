...
//   dotnet run --project Tools/CardGame/AudioGen -- [--out DIR] [--only se|bgm]
// 出力: Assets/_Project/Games/50_CardGame/Resources/Audio/se/*.wav, Audio/bgm/*.wav
...
var outDir = Opt("--out") ?? Path.Combine(repoRoot, "Assets", "_Project", "Games", "50_CardGame", "Resources", "Audio");
var only = Opt("--only");
