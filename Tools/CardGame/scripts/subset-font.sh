...
#
#   bash Tools/CardGame/scripts/subset-font.sh
#
# - 画面に出る文字 = Tools/CardGame/scripts/font-chars.pl が集める(C# の文字列リテラル・カード/デッキの JSON・ASCII・かな全種・記号)
...
perl Tools/CardGame/scripts/font-chars.pl "$TMP/names.txt" --names
...
cp "$TMP/name.ttf" "$FONTS/KaiseiTokumin-ExtraBold.ttf"
